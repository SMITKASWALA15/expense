...
import com.example.expensemanagerproject.ModelClass.ModeModelclass

class DataHelper(context: Context, s: String, nothing: Nothing?, i: Int) : SQLiteOpenHelper(context, "Categorydb", null, 1) {
